                    ...
                    try {
                        sh '''
                            ...
                            if /Applications/Docker.app/Contents/Resources/bin/docker ps | grep scientific-calculator; then
                                ...
                                echo "Scientific Calculator container not found in running containers"
                        ...
                        echo "Continuing pipeline despite health check issues..."
                    }
                }
            }
        }
                ...
                emailext (
                    ...
                    body: """
                        ...
                        <ul>
                            ...
                            <li>Built application with Maven</li>
